...
impl Parameters for MainNetwork {
    fn activation_height(&self, nu: NetworkUpgrade) -> Option<BlockHeight> {
        match nu {
            NetworkUpgrade::Overwinter => Some(BlockHeight(1_140_408)),
            NetworkUpgrade::Sapling => Some(BlockHeight(1_140_409)),
            NetworkUpgrade::Blossom => Some(BlockHeight(7_113_400)),
            NetworkUpgrade::Heartwood => Some(BlockHeight(7_113_401)),
            NetworkUpgrade::Canopy => Some(BlockHeight(7_113_402)),
            NetworkUpgrade::Nu5 => Some(BlockHeight(7_113_403)),
            #[cfg(feature = "zfuture")]
